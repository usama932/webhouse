                        ...
                        <form action="{{route('user.search_artist')}}" method="post" class="mb-5">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Search" name="search">
                                   <input type="hidden" class="form-control" placeholder="Search" value="1" name="subscribe">
                        ...
                        <li class="list_item d-flex align-items-center">
                            ...
                            <div class="list_item_icons ms-auto">   
                                <div class="text-center">
                                    <a href="javascript:;"   data-id="{{ $artist->id }}" class="unsubscribe btn btn_light btn_sm">Unsubscribe</a>
                                </div>
                            </div>
                        </li>   
                    @endforeach

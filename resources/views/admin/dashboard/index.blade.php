...
@include('admin.partials._side_bar')
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <!-- ============================================================== -->
            @php
                $artists = \App\Artist::all()->count();
                $videos = \App\Video::all()->count();
                $audios = \App\Audio::all()->count();
                @endphp
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        <div class="row row-in">
                            <div class="col-lg-4 col-sm-12 row-in-br">
                                <ul class="col-in">
                                    ...
                                    <li class="col-last">
                                        <h3 class="counter text-right m-t-15">{{$artists}}</h3></li>
                                    <li class="col-middle">
                                        <h4>Total Artist</h4>
                                        <div class="progress">
                            ...
                            <div class="col-lg-4 col-sm-12 row-in-br  b-r-none">
                                <ul class="col-in">
                                    <li>
                                        <span class="circle circle-md bg-info"><i class="ti-video-clapper"></i></span>
                                    </li>
                                    <li class="col-last">
                                        <h3 class="counter text-right m-t-15">{{$videos}}</h3></li>
                                    <li class="col-middle">
                                        <h4>Total Videos</h4>
                                        <div class="progress">
                            ...
                            <div class="col-lg-4 col-sm-12  b-0">
                                <ul class="col-in">
                                    <li>
                                        <span class="circle circle-md bg-warning"><i class="fa fa-file-audio-o"></i></span>
                                    </li>
                                    <li class="col-last">
                                        <h3 class="counter text-right m-t-15">{{$audios}}</h3></li>
                                    <li class="col-middle">
                                        <h4>Total Audios</h4>
                                        <div class="progress">

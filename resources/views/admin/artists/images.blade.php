        ...
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Manage Artist Images</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <h3 class="box-title m-b-0">Manage Artist Events</h3>
                <p class="text-muted m-b-30">Artist Events List</p>
                <div class="table-responsive">
                    ...
                    <table id="users" class="table table-striped responsive nowrap" width="100%">
                        ...
                        <tbody>
                        @foreach($user->images as $row)
                        <tr>
                            <td>{{$row->description}}</td>
                            <td><img src="{{asset("uploads/gallery/$row->image")}}" alt="" width="200"></td>
                            <td>{{$row->created_at}}</td>
                            <td>
                                <a title="Show Event" class="btn btn-info btn-circle"
                                   href="{{route("artist-image",$row->id)}}">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </td>
                        </tr>

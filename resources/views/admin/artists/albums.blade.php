        ...
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Manage Artist Albums</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <h3 class="box-title m-b-0">Manage Artist Albums</h3>
                <p class="text-muted m-b-30">Artist Album List</p>
                <div class="table-responsive">
                    ...
                    <table id="users" class="table table-striped responsive nowrap" width="100%">
                        ...
                        <tbody>
                        @foreach($user->albums as $event)
                        <tr>
                            <td>{{$event->name}}</td>
                            <td><img src="{{asset("uploads/album/$event->image")}}" alt="" width="200"></td>
                            <td>{{$event->created_at}}</td>
                            <td>
                                <a title="Show Event" class="btn btn-info btn-circle"
                                   href="{{route("artist-album",$event->id)}}">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </td>
                        </tr>

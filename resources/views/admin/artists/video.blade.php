        ...
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Edit Artist Video</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title m-b-0"> Artist Video-> {{ $user->name }}</h3>
                    {{ Form::model($user, ['method' => 'Post','route' => ['artist-video-status'],'class'=>'form-horizontal','enctype'=>'multipart/form-data'])}}
                    ...
                    @if($user->thumbnail)
                        ...
                        <img src="{{asset("uploads/video/$user->thumbnail")}}" width="200px" alt="">
                        </div>
                    @endif
                    @if($user->video)
                        <div class="col-md-12 form-group">
                            ...
                            <video width="320" height="240" controls>
                                <source src="{{asset("uploads/video/$user->video")}}" >

        ...
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Edit Artist Image</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <h3 class="box-title m-b-0"> Artist Image-> {{ $user->name }}</h3>
                    {{ Form::model($user, ['method' => 'Post','route' => ['artist-image-status'],'class'=>'form-horizontal','enctype'=>'multipart/form-data'])}}
                    <p><b>Description : </b> {{$user->description}}</p>
                    @if($user->image)
                        <img src="{{asset("uploads/gallery/$user->image")}}" width="200px" alt="">
                    @endif

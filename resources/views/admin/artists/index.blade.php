        ...
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Manage Artist</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <a class="btn btn-success pull-right" href="{{route('artists.create')}}">
                    <i class="fa fa-plus"></i> Add New
                </a>
                <h3 class="box-title m-b-0">Manage Artist</h3>
                <p class="text-muted m-b-30">Artist List</p>

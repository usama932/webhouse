        ...
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Manage Artist Audios</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <h3 class="box-title m-b-0">Manage Artist Audios</h3>
                <p class="text-muted m-b-30">Artist Audios List</p>
                <div class="table-responsive">
                    ...
                    <table id="users" class="table table-striped responsive nowrap" width="100%">
                        ...
                        <tbody>
                        @foreach($user->audios as $event)
                        <tr>
                            <td>{{$event->name}}</td>
                            <td><img src="{{asset("uploads/audio/$event->thumbnail")}}" alt="" width="200"></td>
                            <td>{{$event->created_at}}</td>
                            <td>
                                <a title="Show Event" class="btn btn-info btn-circle"
                                   href="{{route("artist-audio",$event->id)}}">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </td>
                        </tr>

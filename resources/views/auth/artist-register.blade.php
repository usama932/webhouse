...
@section("meta")
    <title>Artist Register | Soul Entertainment</title>
@endsection
@section("content")
        ...
        <div class="enter_view_content">
            ...
            <div class="tab-content" id="EnterViewContent">
                ...
                <div class="tab-pane show active section_bg_dark" id="EnterViewArtist">
                    ...
                    <form id="form_register_user" action="{{route("artist.register.submit")}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row justify-content-center">

                            <div class="col-sm-8 mb-3 text-center">
                                <h4 class="EnterView_tab_title">Register As Artist</h4>
                            </div>

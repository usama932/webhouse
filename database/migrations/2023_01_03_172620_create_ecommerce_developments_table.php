...
class CreateEcommerceDevelopmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ecommerce_developments', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ecommerce_developments');
    }
}

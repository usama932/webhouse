...
class CreateMobileAppDevelopmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mobile_app_developments', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('mobile_app_developments');
    }
}
